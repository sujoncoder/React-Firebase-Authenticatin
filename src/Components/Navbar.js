  ...
  return (
    <header className='bg-purple-200 w-full h-14 px-4 flex justify-between items-center'>
      ...
      <div className='hidden sm:flex space-x-4 font-semibold text-slate-500 cursor-pointer'>
        ...
        <CustomLink className='hover:text-blue-600 duration-300' to='/login'>Login</CustomLink>
      </div>
      ...
      <div onClick={handleOpen} className='cursor-pointer'>
        ...
        <div className={(!open) ? 'hidden' : 'absolute top-14 left-0 flex flex-col w-full text-center px-10 font-semibold'}>
